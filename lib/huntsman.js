...
module.exports = function( options ){
  ...
  huntsman.options.interval = huntsman.options.interval || 1000;
  huntsman.options.timeout = huntsman.options.timeout || 5000;
  huntsman.proxy = huntsman.options.proxy || new (require('./proxy/http'))(options);
  ...
  huntsman.start = function(){
    ...
    huntsman.loop = setInterval( huntsman.next, huntsman.options.interval );
    huntsman.next( true );
  };
